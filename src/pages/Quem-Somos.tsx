...
const Sobre = () => {
  ...
  const valores = [{
    ...
    descricao: "Comprometimento com a excelência e integridade em cada detalhe, garantindo o melhor cuidado para todos que cruzam nossa porta."
  }, {
    icon: <Users className="w-8 h-8" />,
    titulo: "Pertencimento e Escuta Ativa",
    descricao: "Construímos um espaço onde cada voz é ouvida e respeitada, promovendo um ambiente de verdadeira conexão."
  }, {
    icon: <Shield className="w-8 h-8" />,
    titulo: "Respeito à Diversidade e às Singularidades",
    descricao: "Celebramos a individualidade e abraçamos todas as diferenças, criando um lugar de inclusão e compreensão."
  }, {
    icon: <Star className="w-8 h-8" />,
    titulo: "Ambiente Afetuoso e Acolhedor",
    descricao: "Transformamos o cuidado em um abraço caloroso, onde todos se sentem em casa e seguros para ser quem são."
  }];
