...
const Sobre = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-gradient-to-br from-terracota/10 to-bege-suave">
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-on-scroll">
              <h2 className="text-azul-confianca mb-6">Nossa História</h2>
      ...
      <section className="section-padding bg-branco-ninho">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="animate-on-scroll">
              <img 
                src="https://images.unsplash.com/photo-1631889993959-41b4e9c81d20?auto=format&fit=crop&w=600&q=80"
            ...
            <div className="animate-on-scroll">
              <img 
                src="https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?auto=format&fit=crop&w=600&q=80"
