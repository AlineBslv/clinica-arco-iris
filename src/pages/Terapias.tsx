  ...
  const terapias = [
    {
      ...
      detalhes: [
        "Atendimento clínico para ansiedade, depressão e dificuldades emocionais",
        "Apoio parental e orientação para famílias",
        "Psicoterapia infantil com abordagem lúdica",
        "Atendimento a adolescentes com foco em identidade, autoestima e relações",
        "Psicoterapia para adultos em momentos de transição, luto, burnout ou conflitos internos"
      ],
      cor: "roxo-principal",
      destaque: true
    },
    {
      ...
      detalhes: [
        "Intervenção em atrasos de fala e linguagem",
        "Tratamento de gagueira, trocas na fala e dificuldades de articulação",
        "Desenvolvimento da linguagem em crianças neurodivergentes",
        "Terapia para dificuldades de leitura e escrita (dislexia)",
        "Treinamento de habilidades auditivas e orais"
      ],
      cor: "roxo-claro",
      destaque: false
    },
    {
      ...
      detalhes: [
        "Estimulação sensorial e motora para crianças",
        "Desenvolvimento da coordenação motora fina e grossa",
        "Treinamento de habilidades de vida diária (vestir-se, comer, brincar, organizar)",
        "Apoio no planejamento de rotina e adaptação escolar",
        "Intervenções para adultos com estresse ocupacional ou TEA"
      ],
      cor: "roxo-suave",
      destaque: false
    },
    {
      ...
      detalhes: [
        "Avaliações neuropsicológicas completas (TDAH, TEA, dislexia, etc.)",
        "Relatórios para escola, laudos e encaminhamentos",
        "Reabilitação cognitiva para memória, atenção e funções executivas",
        "Apoio à aprendizagem com base no perfil cognitivo da criança",
        "Suporte a adultos em mudanças cognitivas (ex: pós-COVID, envelhecimento)"
      ],
      cor: "roxo-principal",
      destaque: false
    },
    {
      ...
      detalhes: [
        "Intervenção para dificuldades escolares (dislexia, discalculia)",
        "Organização dos estudos e rotina escolar",
        "Apoio à alfabetização e letramento",
        "Atendimento a estudantes com bloqueios ou desmotivação escolar",
        "Acompanhamento interdisciplinar com escola e família"
      ],
      cor: "roxo-claro",
      destaque: false
    },
    {
      ...
      detalhes: [
        "Estimulação motora precoce para bebês e crianças",
        "Reabilitação pós-lesão ou cirurgia",
        "Tratamento de dores musculares e posturais",
        "Fisioterapia neurológica e ortopédica",
    ...
    },
    {
      ...
      detalhes: [
        "Planejamento alimentar para crianças e adultos",
        "Educação nutricional para seletividade alimentar",
        "Apoio no tratamento de distúrbios alimentares (compulsão, ansiedade alimentar)",
        "Nutrição materno-infantil e na introdução alimentar",
        "Promoção de hábitos saudáveis sem dietas rígidas"
      ],
      cor: "roxo-principal",
      destaque: false
    },
    {
      ...
      detalhes: [
        ...
        "Reforço positivo para comportamentos funcionais",
        "Apoio a crianças com TEA e atraso no desenvolvimento",
        "Envolvimento da família no processo terapêutico",
        "Intervenções estruturadas com metas claras e mensuráveis"
      ],
      cor: "roxo-claro",
      destaque: false
    },
    {
      ...
      detalhes: [
        ...
        "Apoio complementar em processos de reabilitação física ou emocional"
      ],
      cor: "roxo-suave",
      destaque: false
    },
    {
      ...
      detalhes: [
        "Limpeza de pele e cuidados faciais",
        "Procedimentos de bem-estar e relaxamento corporal",
        "Atendimento estético com olhar humanizado",
        "Apoio à construção da autoimagem e autocuidado"
      ],
      cor: "roxo-principal",
      destaque: false
    },
    {
      ...
      detalhes: [
        "Alívio de dores físicas crônicas ou agudas",
        "Tratamento auxiliar para ansiedade, insônia e estresse",
        "Reequilíbrio energético e emocional",
        "Estímulo ao bem-estar geral"
      ],
      cor: "roxo-claro",
      destaque: false
    },
    {
      ...
      detalhes: [
        "Entendimento das emoções que influenciam o consumo",
        "Planejamento financeiro com abordagem personalizada",
        "Redução da ansiedade financeira",
        "Apoio para casais e famílias na organização financeira",
        "Educação financeira voltada à autonomia e segurança emocional"
      ],
      cor: "roxo-suave",
      destaque: false
    }
                ...
                <div className={`animate-on-scroll ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                  <img 
                    src={`https://images.unsplash.com/photo-${
                      ...
                      index === 2 ? '1609220136736-443140cceacc' :
                      index === 3 ? '1559757148-5c350d0d3c56' :
                      index === 4 ? '1481627834876-b7833e8f006c' :
                      index === 5 ? '1571019613454-1cb2f99b2d8b' :
                      index === 6 ? '1490645935967-10de6ba17061' :
                      index === 7 ? '1544027993-37dbfe43562a' :
                      index === 8 ? '1571019613454-1cb2f99b2d8b' :
                      index === 9 ? '1616391182219-e080b4d1043a' :
                      index === 10 ? '1582750433449-648ed127bb54' :
                      '1554224154-26032fced8bd'
            ...
            {planos.map((plano, index) => (
              <div key={index} className={`card-custom hover-lift animate-on-scroll ${plano.destaque ? 'ring-2 ring-roxo-principal relative' : ''}`}>
                ...
                <a 
                  ...
                  className={`${plano.destaque ? 'btn-roxo' : `btn-secondary text-${plano.cor} border-${plano.cor} hover:bg-${plano.cor} hover:text-branco-ninho`} w-full text-center`}
                >
                  Agendar Consulta
                </a>
              </div>
