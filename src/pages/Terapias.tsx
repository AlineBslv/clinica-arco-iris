      ...
      <section className="pt-32 pb-16 bg-roxo-principal">
        <div className="container-custom">
          <div className="text-center animate-on-scroll">
            ...
            <p className="text-xl text-branco-ninho max-w-3xl mx-auto leading-relaxed">Na Casa Arco-Íris, oferecemos atendimentos interdisciplinares que cuidam do ser humano por inteiro. Conheça nossas áreas de atuação e descubra como cada uma pode transformar vidas com carinho, técnica e propósito</p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-16">
            {terapias.map((terapia, index) => <div key={index} className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                <div className={`animate-on-scroll ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  {terapia.destaque && <div className="inline-block px-3 py-1 bg-roxo-principal text-branco-ninho rounded-full text-sm font-medium mb-4">
