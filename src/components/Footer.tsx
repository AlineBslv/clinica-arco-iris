        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-terracota to-violeta-lavanda rounded-full flex items-center justify-center">
                <span className="text-branco-ninho font-lora font-semibold text-lg">CA</span>
              </div>
              <div>
                <h3 className="font-lora font-semibold text-xl">Casa Arco Íris</h3>
                <p className="text-branco-ninho/80 text-sm">Terapias Especializadas</p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-3 bg-branco-ninho/10 rounded-lg text-branco-ninho hover:bg-branco-ninho/20 transition-all duration-300 hover:-translate-y-1"
            ...
            <ul className="space-y-3">
              {menuItems.map((item) => (
                <li key={item.name}>
                  <a
                    href={item.href}
                    className="text-branco-ninho/80 hover:text-branco-ninho transition-colors duration-300 inline-block"
                  >
                    {item.name}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center space-x-3 text-branco-ninho/80 hover:text-branco-ninho transition-colors duration-300"
              >
